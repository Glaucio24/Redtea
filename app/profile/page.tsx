  ...
  return (
    <div className="p-2 sm:p-4 lg:p-8 max-w-6xl mx-auto text-white bg-transparent">
      <div className="mb-6 lg:mb-8 px-2">
        <h1 className="text-xl sm:text-3xl font-bold mb-1">My Profile</h1>
        <p className="text-gray-400 text-[10px] sm:text-sm">Your anonymous identity and community stats</p>
      </div>
      ...
      <Card className="bg-gray-950 border-gray-800 mb-6 lg:mb-8 rounded-3xl overflow-hidden shadow-2xl border-none">
        <CardHeader className="bg-gradient-to-r from-red-900/20 to-transparent border-b border-gray-800/40 p-4 sm:p-6">
          <CardTitle className="text-white text-xs sm:text-base lg:text-xl font-semibold uppercase tracking-wider">Active Pseudonym</CardTitle>
        </CardHeader>
      ...
      <div className="space-y-4">
        <div className="px-2">
            <h3 className="text-base sm:text-xl font-bold">My Contributions</h3>
        </div>
